...
def get_indexed_log_path(log_dir, base_name):
...
def setup_logger(
    ...
    # File handler with indexed rotation
    file_path = get_indexed_log_path(log_dir, name)
...
#     backup_count=40             # Number of rotated files to keep
# ):
